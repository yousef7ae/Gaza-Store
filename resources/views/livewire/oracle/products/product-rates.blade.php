            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select wire:model.defer="product_rate.rate"
                                class="form-control form-control-sm @error('product_rate.rate') is-invalid @enderror">
                            <option value="0">{{__("Rate")}} ...</option>
                            @for ($i = 0; $i <= 5 ; $i++)
                                <option value="{{$i}}">{{$i}}</option>
                            @endfor
                        </select>
                        @error('product_rate.rate')
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea rows="5" value="" wire:model.defer="product_rate.comment"
                                  placeholder="{{ __('Add Comment') }}"
                                  name="description"
                                  class="form-control @error('product_rate.comment') is-invalid @enderror"
                                  type="text"></textarea>
                        @error('product_rate.comment')
                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
                </div>
