...
{{--        <img class="w-100" src="/Dukkan/images/bg-Profile.png" alt="">--}}
{{--        <div--}}
...
{{--    </div>--}}
    <div class="container">
        <div class="row my-5">
            @if($carts->count() > 0)
                <div class="col-12">
                    <h3 class="text-danger mb-3 font-weight-bold">{{__("Shopping Cart")}}
                        ...
                        <div class="card shadow card-body rounded-lg border-0 mb-3">
                            <div class="row no-gutters">
                                ...
                                <div class="col-6">
                                    ...
                                    {{--                                                   class=" input-hover pointer input-o rounded-circle  w-25p h-25p"--}}
                                    {{--                                                   for="color1">--}}
                                    {{--                                            </label>--}}
                                    {{--                                        </div>--}}
                                    {{--                                        <div class="mx-1">--}}
                                    ...
                                    <div class="row mx-auto w-100 px-2">
                                                    <span class="btn btn-danger col-3 col-sm-2 w-35p h-35p d-flex justify-content-center align-items-center"
            ...
            <div class="col-lg-5">
                    ...
                    <div class="card shadow card-body rounded-lg border-0 mb-3">
                        ...
                        <button type="button" wire:click="$set('add_new_address', {{!$add_new_address}})"
                                class="btn btn-danger">{{__("Add New Address")}}</button>
                        ...
                        @if($add_new_address)
                            ...
                            {{--                                            <input disabled type="text" id="country" wire:model.defer="new_address.country"   class="form-control" placeholder="">--}}
                            {{--                                        </div>--}}
                            {{--                                        <div class="form-group">--}}
                            {{--                                            <label for="name">City<span>*</span></label>--}}
                            {{--                                            <input disabled type="text" id="country" wire:model.defer="new_address.city"   class="form-control" placeholder="">--}}
                            {{--                                        </div>--}}
                            {{--                                        <div class="form-group">--}}
                            {{--                                            <label for="name">Address<span>*</span></label>--}}
                            {{--                                            <input disabled type="text" id="location" wire:model.defer="new_address.location"  class="form-control" placeholder="">--}}
                            {{--                                        </div>--}}
                            <div class="form-group">
                ...
                <div class="card card-body border-0 shadow-sm rounded-lg mb-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item font-weight-bold py-3"><h4>{{__("Total (incl. VAT)")}} <span
                                    class="float-right">{{$total}} {{$cart->product->store->currency->code}}</span></h4></li>
                    </ul>
                </div>
                <div class="text-right">
                    <button class="btn btn-lg btn-danger" wire:click.prevent="confirm"><i
                            class="fa fa-check"></i>
                        {{__("Confirm")}}
                    </button>
                </div>
