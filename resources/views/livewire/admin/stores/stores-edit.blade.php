<form class="mt-2 w-100 bg-white" method="post" wire:submit.prevent="update">
    {{csrf_field()}}
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <div id="store_map2" style="height:200px;" wire:ignore></div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <h3>{{ __('Payment getways') }}</h3>
                        @foreach(App\Models\PaymentGateway::get() as $key => $payment)
                            <div class="text-start">
                                <label class="control-label">
                                    <input wire:model.defer="store.payment_gateways.{{$key}}" value="{{$payment->id}}"
                                           class="@error('store.payment_gateways') is-invalid @enderror"
                                           type="checkbox"/>{{$payment->name}}</label>
                            </div>
                        @endforeach
                ...
                <div class="row justify-content-center">
                    <div class="col-md-2">
                        <div class="form-group">
                            <button wire:loading.attr="disabled" wire:click.prevent="ActiveTab(1)"
                                    class="btn @if ($active == 1) btn-success disabled @else btn-primary @endif   mb-2"
                                    type="submit"><i class="fab fa-facebook-f"></i></button>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <button wire:loading.attr="disabled" wire:click.prevent="ActiveTab(2)"
                                    class="btn @if ($active == 2) btn-success disabled @else btn-primary @endif   mb-2"
                                    type="submit"><i class="fab fa-instagram"></i></button>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <button wire:loading.attr="disabled" wire:click.prevent="ActiveTab(3)"
                                    class="btn @if ($active == 3) btn-success disabled @else btn-primary @endif   mb-2"
                                    type="submit"><i class="fab fa-whatsapp"></i></button>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <button wire:loading.attr="disabled" wire:click.prevent="ActiveTab(4)"
                                    class="btn @if ($active == 4) btn-success disabled @else btn-primary @endif   mb-2"
                                    type="submit"><i class="fab fa-twitter"></i></button>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <button wire:loading.attr="disabled" wire:click.prevent="ActiveTab(5)"
                                    class="btn @if ($active == 5) btn-success disabled @else btn-primary @endif   mb-2"
                                    type="submit"><i class="fab fa-telegram-plane"></i></button>
                        </div>
                    </div>
                </div>
...
<script>
    function initMapLocations2(lat, lng, div) {
    ...
    initMapLocations2({{$store['lat']}}, {{$store['lng']}}, "store_map2")
</script>
