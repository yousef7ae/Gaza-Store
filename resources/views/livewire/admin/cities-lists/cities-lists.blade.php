                                        ...
                                        @foreach($cities as  $key => $city)
                                            <tr>
                                                ...
                                                <td>
                                                    @if($city->status == 1  )
                                                        <span
                                                            class="btn btn-success btn-xs">{{ \App\Models\Slider::statusList($city->status)}}</span>

                                                    @elseif( $city->status == 0)
                                                        <span
                                                            class="btn btn-danger btn-xs">{{ \App\Models\Slider::statusList($city->status)}}</span>
                                                    @else
                                                        <span
                                                            class="btn btn-primary btn-xs">{!! \App\Models\Slider::statusList($city->status) !!}</span>
                                                    @endif
                                                </td>
                                                <td>
