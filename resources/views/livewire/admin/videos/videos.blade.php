                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        @if(auth()->user()->can('videos create'))
                            <a class="btn btn-primary float-end"  data-bs-toggle="modal" data-bs-target="#CreateVideo" wire:click.prevent="CreateVideo" data-bs-original-title="" title=""> {{__('Create Video')}}</a>
                        @endif
                    </div>
                </div>
            </div>
                                            ...
                                            <td>
                                                @if(auth()->user()->can('videos edit'))
                                                    ...
                                                    <a class="btn btn-primary btn-xs"
                                                       href="#" data-bs-toggle="modal" data-bs-target="#EditVideo"
                                                ...
                                                @if(auth()->user()->can('videos delete'))
                                                    <a class="btn btn-xs btn-danger" href="#"
                                                       wire:click.prevent="deleteId({{$video->id}})"
...
@if(auth()->user()->can('videos create'))
    <!--  Modal CreateVideo -->
        <div wire:ignore.self class="modal fade " id="CreateVideo" tabindex="-1" role="dialog"
             aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content text-center">
                    <div class="modal-header text-center">
                        <h5 class="modal-title text-center" id="exampleModalLongTitle">{{ __('Create Video') }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    ...
                    <div class="modal-body">
                        ...
                        @if($create_video)
                            @livewire('admin.videos.videos-create')
                        @endif
...
@if(auth()->user()->can('videos edit'))
    <!--  Modal EditVideo -->
        <div wire:ignore.self class="modal fade " id="EditVideo" tabindex="-1" role="dialog"
             aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content text-center">
                    <div class="modal-header text-center">
                        <h5 class="modal-title text-center" id="exampleModalLongTitle">{{ __('Video') }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        ...
                        @if($video_id)
                            @livewire('admin.videos.videos-edit',[$video_id])
                        @endif
                    </div>
                </div>
            </div>
