        ...
        {{-- @if (auth()->user()->hasRole('Admin'))
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select wire:change = "setProduct" wire:model.defer="coupon.store_id"
                            class="form-control @error('coupon.store_id') is-invalid @enderror" type="text">
                        <option value="">{{__("Select")}}</option>
        ...
        {{-- <div class="col-md-6">
            <div class="form-group">
                ...
                <select wire:change = "setProduct" wire:model="coupon.category_id"
                        class="form-control @error('coupon.category_id') is-invalid @enderror" type="text">
                    <option value="">{{__("Select")}}</option>
