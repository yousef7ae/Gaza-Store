...
{{-- <input wire:model.defer="coupon.code" placeholder="{{__("code")}}"--}}

{{-- class="form-control @error('coupon.code') is-invalid @enderror" type="text">--}}
{{-- @error('coupon.code')--}}
...
{{-- class="form-control @error('coupon.product_id') is-invalid @enderror" type="text">--}}
...
{{-- <input wire:model.defer="coupon.value" placeholder="{{__("value")}}"--}}

{{-- class="form-control @error('coupon.value') is-invalid @enderror" type="number">--}}
{{-- @error('coupon.value')--}}
{{-- <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>--}}
{{-- @enderror--}}
...
{{-- class="form-control @error('coupon.expiration') is-invalid @enderror"--}}
{{-- type="datetime-local">--}}
...
<form class="mt-2 w-100" method="post" wire:submit.prevent="update">
    ...
    <div class="row">
        ...
        <select wire:change="setProduct" wire:model.defer="coupon.store_id" class="form-control @error('coupon.store_id') is-invalid @enderror" type="text">
            <option value="">{{__("Select")}}</option>
    ...
    {{-- <select wire:change = "setProduct" wire:model="coupon.brand_id"--}}
    ...
    <div>
        <button wire:loading.attr="disabled" class="btn btn-primary submit" type="submit">{{__("Update")}}</button>
    </div>
</form>
