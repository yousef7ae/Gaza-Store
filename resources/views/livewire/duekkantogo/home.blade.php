...
{{--            <div class="container">--}}
{{--                <h2 class="text-secondary mb-4">{{__("New products")}}</h2>--}}
            ...
            <div class="row justify-content-between">
                @foreach($ads->take(1) as $ad)
                    ...
                    <div class="col-md-12 my-2">
                        <a href="/stores" class="shopping shopping2 overlay px-3 rounded-10 d-block" style="background: url({{$ad->image}}) center center no-repeat;width: 100%;height: 250px;">
...
{{--        <section class="my-3 most">--}}
{{--            <div class="container">--}}
{{--                <h2 class="text-secondary mb-4">{{__("Most Wanted")}}</h2>--}}
{{--                <div class="row">--}}
...
{{--    @endif--}}
    ...
    <section class="py-4 take">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="text-secondary mb-4">{{__("Brands")}}</h4>
