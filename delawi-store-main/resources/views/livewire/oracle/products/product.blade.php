...
{{--                                               href="#">{{$product->store ? $product->store->name : '-'}}</a></li>--}}
                ...
                <li class="breadcrumb-item text-danger font-weight-bold active"
        ...
        <div class="row Product">
                        ...
                        <div class="col-md-12">
                            @if($product->ProductDetails->count())
                                @foreach($product->ProductDetails as $ProductDetail)
                                    ...
                                    <h4>{{$product->name}}</h4>
                                    <span class="text-danger h4 pr-4">{{$ProductDetail->price_string}}</span>
            ...
            <div class="col-lg-5 pt-2 pt-lg-0">
                {{--                <p class="mt-2 d-inline-flex align-items-center"><i class="fas text-danger pr-3 fa-shuttle-van"></i>--}}
        ...
        <section class="my-3 most">
            ...
            <div class="container">
                <h3 class="text-danger font-weight-bold">{{__("Product Reviews")}}</h3>
                                        ...
                                        <div class="mb-5 pt-4">
                                            <div class="media MOHAMMED">
                                                <div class="media-body">
                                                    <h5 class="mb-0 text-danger">{{$product_rate->user ? $product_rate->user->name : '-'}}</h5>
                                                </div>
                                                <img
    ...
    <section class="mb-4 mt-3">
        <div class="container">
            <hr class="h2-desc pb-3 mb-4 border-bottom border-secondary"/>
            <h3 class="text-danger font-weight-bold">{{__("Most wanted")}}</h3>
