        ...
        @if($store->sliders->count() > 0)
            <div class="owl-carousel owl-theme archive">
                @foreach($sliders as $slider)
                    <div class="item">
                        <div class="d-flex align-items-center vh-100 overlay overflow-hidden" style="height: 400px">
                            <img class="w-100"
...
{{--                            <h5 class="mt-0 text-danger">{{$store->name}}</h5>--}}
...
{{--            <div class="row">--}}
{{--                <div class="col-lg-6">--}}
{{--                    <h5 class="border-bottom font-weight-bold pb-3 text-uppercase text-danger"><span--}}
...
{{--                                    <i class="far fa-star fs-25p text-danger"></i>--}}
{{--                                    <h5 class="text-danger mb-1">{{$store->rate}}</h5>--}}
{{--                                    <p>{{__("Evaluation")}}</p>--}}
{{--                                </div>--}}
{{--                                <div class="col-md col-6  text-center">--}}
{{--                                    <i class="fab fa-palfed fs-25p text-danger"></i>--}}
{{--                                    <h5 class="text-danger mb-1">{{$store->products->count()}}</h5>--}}
{{--                                    <p>{{__("Products")}}</p>--}}
{{--                                </div>--}}
{{--                                <div class="col-md col-6  text-center">--}}
{{--                                    <i class="fas fa-users fs-25p text-danger"></i>--}}
{{--                                    <h5 class="text-danger mb-1">{{$store->orders->count()}}</h5>--}}
{{--                                    <p>{{__("Customers")}}</p>--}}
{{--                                </div>--}}
{{--                                <div class="col-md-5 col-6  text-center">--}}
{{--                                    <i class="far fa-clock fs-25p text-danger"></i>--}}
...
{{--            </div>--}}
    ...
    <section class="my-3 most">
        <div class="container">
            <h2 class="text-danger mb-4">{{__("Products")}}</h2>
            <div class="row">
...
{{--                                    <span class="font-weight-bold text-danger d-block fa-2x">,....</span>--}}
{{--                                    <p class="">{{$store_rate->comment}}</p>--}}
{{--                                    <span--}}
{{--                                        class="font-weight-bold text-danger d-block text-right mt-n3 fa-2x">,....</span>--}}
{{--                                    <div class="mb-5 pt-4">--}}
{{--                                        <div class="media MOHAMMED">--}}
{{--                                            <div class="media-body">--}}
{{--                                                <h5 class="mb-0 text-danger">{{$store_rate->user ? $store_rate->user->name : '-'}}</h5>--}}
{{--                                            </div>--}}
{{--                                            <img--}}
