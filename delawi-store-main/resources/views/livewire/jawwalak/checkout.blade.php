                ...
                <div class="card card-body border-0 shadow-sm rounded-lg mb-3">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item font-weight-bold py-3">{{__("Total Price")}}<span
                                class="float-right">{{$total}} {{(!empty($cart) and $cart->product)?$cart->product->store->currency->code:null}}</span></li>
                        <li class="nav-item font-weight-bold py-3 border-bottom">{{__("Delivery Fee")}} <span
                                class="float-right">0 {{(!empty($cart) and $cart->product)?$cart->product->store->currency->code:null}}</span>
                        </li>
                        <li class="nav-item font-weight-bold py-3"><h4>{{__("Total (incl. VAT)")}} <span
                                    class="float-right">{{$total}} {{(!empty($cart) and $cart->product)?$cart->product->store->currency->code:null}}</span></h4></li>
                    </ul>
                </div>
