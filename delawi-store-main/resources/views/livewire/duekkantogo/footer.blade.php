        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-sm-6 text-sm-left text-center">
                  <img class="mb-3" width="140" src="{{ ($logo = \App\Models\Setting::where('name','logo')->first()) ? url("storage/".$logo->value) : url('Dukkan/images/logo-white.svg')}}" alt="" style="padding: 10px;border-radius: 5px; background: var(--bg-secondary)">
{{--                    <img class="mb-3" width="170" src="{{ ($logo = \App\Models\Setting::where('name','logo')->first()) ? url("storage/".$logo->value) : url('storage/logos/7AV6lYMpjXT1EXQkgiuNzHmCAdYanDdcDqcAGd5w.png')}}" alt="" style="padding: 10px;border-radius: 5px;">--}}
