...
{{--                        <img width="58" class="logo-img" src="{{ ($logo = \App\Models\Setting::where('name','logo')->first()) ? url("storage/".$logo->value) : url('Dukkan/images/logo-white.svg')}}" alt="">--}}
                        <img width="90" class="logo-img" src="{{ ($logo = \App\Models\Setting::where('name','logo')->first()) ? url("storage/".$logo->value) : url('storage/logos/7AV6lYMpjXT1EXQkgiuNzHmCAdYanDdcDqcAGd5w.png')}}" alt="">
                    </a>
...
{{--                                    <img class="img-fluid" width="100" src="{{ ($logo = \App\Models\Setting::where('name','logo')->first()) ? url("storage/".$logo->value) : url('assets/images/logo.png')}}" alt="">--}}
                                    <img class="img-fluid" width="100" src="{{ ($logo = \App\Models\Setting::where('name','logo')->first()) ? url("storage/".$logo->value) : url('storage/logos/7AV6lYMpjXT1EXQkgiuNzHmCAdYanDdcDqcAGd5w.png')}}" alt="">
                                </a>
                            </li>
                            @if($menus)
