                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        @if(auth()->user()->can('ads create'))
                            <a class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#CreateAd"
                               wire:click.prevent="CreateAd" data-bs-original-title="" title=""> {{__('Create Ad')}}</a>
                        @endif
                    </div>
                </div>
            </div>
...
{{--                                            <th>{{__("Product")}}</th>--}}
                                        ...
                                        @foreach($ads as  $key => $ad)
                                            <tr>
                                                ...
                                                <td>{{$ad->title}}</td>
{{--                                                <td>{{$ad->store?$ad->store->name:''}}</td>--}}
{{--                                                <td>{{$ad->product?$ad->product->name:''}}</td>--}}
                                                <td>{{$ad->date}}</td>
                                                <td>
                                                    @if($ad->status == 1)
                                                        <span
...
@if(auth()->user()->can('ads create'))
    <!--  Modal CreateAd -->
        <div wire:ignore.self class="modal fade " id="CreateAd" tabindex="-1" role="dialog"
             aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content text-center">
                    <div class="modal-header text-center">
                        <h5 class="modal-title text-center" id="exampleModalLongTitle">{{ __('Create Ad') }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    ...
                    <div class="modal-body">
                        ...
                        @if($create_ad)
                            @livewire('admin.ads.ads-create',['store_id' => $store_id])
                        @endif
    ...
    <!--  Modal EditAd -->
        <div wire:ignore.self class="modal fade " id="EditAd" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content text-center">
                    <div class="modal-header text-center">
                        <h5 class="modal-title text-center" id="exampleModalLongTitle">{{ __('Ad') }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
