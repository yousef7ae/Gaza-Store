                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <a class="btn btn-primary float-end"  data-bs-toggle="modal"
                           data-bs-target="#CreatePage" data-bs-original-title="" title=""> {{__('Create Page')}}</a>
                        @endif
                    </div>
                </div>
            </div>
...
{{--                                            <td>--}}
{{--                                                {{route('admin.page',$page->id)}}--}}
{{--                                                <br>--}}
{{--                                                {{route('admin.page',$page->slug)}}--}}
{{--                                            </td>--}}
                                            <td>{{$page->order}}</td>
                                            <td>
                                                @if(auth()->user()->can('pages edit'))
                                                <a class="btn btn-primary btn-xs"
                                                   href="#" data-bs-toggle="modal" data-bs-target="#EditPage"
...
@if(auth()->user()->can('pages edit'))
    ...
    <div wire:ignore.self class="modal fade " id="EditPage" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content text-center">
                <div class="modal-header text-center">
                    <h5 class="modal-title text-center" id="exampleModalLongTitle">{{ __('Page') }}</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true close-btn"></span>
                    </button>
                </div>
