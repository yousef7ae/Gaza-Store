...
class UserController extends Controller
{
    ...
    public function forget_confirm()
    {
        ...
        $user->passweord = Hash::make(request('password'));
        $user->save();
    ...
    public function profile()
    {
        ...
        if (request('license_picture')) {
            ...
            $user->license_picture = request('license_picture')->store('license/' . $user->id . '/' . $this->id);
        }
        ...
        if (request('vehicle_picture')) {
            ...
            $user->vehicle_picture = request('vehicle_picture')->store('vehicle/' . $user->id . '/' . $this->id);
        }
